          ...
          <div class="col-lg-6">
            <div class="p-5">
              ...
              <form class="user" action="insertuser_p.php">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="state" name="state" aria-describedby="emailHelp" placeholder="Enter state">  <input type="hidden" id="type" name="type">
                    </div>
                    <div class="form-group" >
