...
<div class="col-lg-6">
<b><p  class="text-success text-center" style="font-size:36px">Insert New User Details</p></b>   <!--username email password contactno country address city state pincode-->
  <form class="user" action="insertuser_p.php">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="user" name="user" aria-describedby="emailHelp" placeholder="Enter user name">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="cno" name="cno" aria-describedby="emailHelp" placeholder="Enter contact no">
                    </div>
                    
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="pcode" name="pcode" aria-describedby="emailHelp" placeholder="Enter pincode">
                    </div>
          ...
          <font style="font-size:18px"> User</font>&nbsp;&nbsp;<input type="radio" id="type" name="type" value="user"> <font style="font-size:18px">Admin&nbsp;&nbsp;<input type="radio" id="type" name="type" value="admin">
