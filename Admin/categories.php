...
<a style="color:#FFF" href="updatecat.php?c_id=<?php echo $row[0];?>"> UPDATE </a>
</button>
<?php
echo"</td>";
echo"<td>";
...
<a style="color:#FFF" href="deletecat.php?id=<?php echo $row[0];?>"> DELETE </a>
</button>
<?php
echo"</td>";
echo"</tr>";
...
<div class="col-lg-6">
<center>
<button type="button" class="btn btn-success"><a style="color:#FFF" href="insertcat.php">INSERT CATEGORY</a></button>        
</center>
<div class="col-lg-3"></div>
</div>
</div></div></div></div>
