...
echo"<td style=color:#000000><img src='uploads/$row[3]' height='50px' width='50px'> </td>";
...
<a style="color:#FFF" href="updateorder.php?o_id=<?php echo $row[0];?>"> UPDATE </a>
</button>
<?php
echo"<td>";
?>
<button type="danger" class="btn btn-danger">
<a style="color:#FFF" href="deleteorder.php?id=<?php echo $row[0];?>"> DELETE </a>
</button>
<?php
echo"</td>";
?>
