              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h2 class=" text-primary mb-4"><b>Update Order</b></h1>
                  </div>
                  <form method="get" class="user" action="updateorder_p.php">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="status" name="status" value="<?php echo"$row[6]"; ?>">
                    </div>
