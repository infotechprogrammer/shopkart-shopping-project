...
<div class="col-lg-6">
<b><p  class="text-success text-center" style="font-size:36px">Insert sub category</p></b>
  <form class="user" action="insertsubcat_p.php">
  <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="c_id" name="c_id" aria-describedby="emailHelp" placeholder="Enter category id">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="subcat" name="subcat" aria-describedby="emailHelp" placeholder="Enter new sub category">
                    </div>
