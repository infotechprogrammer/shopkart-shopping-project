              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h2 class=" text-primary mb-4"><b>Update Sub Category</b></h1>
                  </div>
                  <form method="get" class="user" action="updatesubcat_p.php">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="catid" name="catid" value="<?php echo"$row[1]"; ?>">
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="subcatname" name="subcatname" value="<?php echo"$row[2]"; ?>">
                    </div>
                   <div class="form-group">
