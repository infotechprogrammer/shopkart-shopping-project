              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h2 class=" text-primary mb-4"><b>Update Category</b></h1>
                  </div>
                  <form method="get" class="user" action="updatecat_p.php">
                                      <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="cname" name="cname" value="<?php echo"$row[1]"; ?>">
                    </div>
                    <div class="form-group">
                    <input type="hidden" class="form-control form-control-user" id="id" name="id" value="<?php echo"$row[0]"; ?>">
                   </div>
                   <div class="form-group">
