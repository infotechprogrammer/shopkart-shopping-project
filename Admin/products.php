...
<div class="spinner-grow text-warn" role="status">
...
{
echo "<table cellpadding=10 class='table table-sm table-hover table-responsive'>";
?>
<tr class="text-warn">
<th>Product ID</th>
...
<img src="uploads/<?php echo $row[6];?>" height="50px" width="50px">
...
<a style="color:#FFF" href="updateprod.php?pid=<?php echo $row[0];?>"> UPDATE </a>
</button>
<?php
echo"</td>";
echo"<td>";
...
<a style="color:#FFF" href="deleteprod.php?id=<?php echo $row[0];?>"> DELETE </a>
</button>
<?php
echo"</td>";
echo"</tr>";
...
<div class="col-lg-6">
<center>
<button type="button" class="btn btn-success"><a style="color:#FFF" href="insertprod.php">INSERT NEW PRODUCT</a></button>        
</center>
<div class="col-lg-3"></div>
</div>
</div>
