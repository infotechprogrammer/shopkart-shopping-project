...
<div class="col-3"></div>
<div class="col-6">
 <form action="uploadimg_p.php" method="post" e enctype="multipart/form-data">
                    <div class="form-group" align="center">
                    &nbsp;&nbsp; <font style="font-size:20px; color:#666F"> Product Image:</font><input class="form-control" type="file" name="file">
