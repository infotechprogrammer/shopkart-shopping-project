...
?>      
  ...
  <?php }} ?>            
             ...
             echo "<li><a href='#'>Account<span class='caret'></span></a>";
              ...
              <li><a href='order1.php'><span class='fa fa-shopping-cart'></span>&nbsp;Order</a>
              </li>
              <?php } ?> 
              </ul>
          </div><!--/.nav-collapse -->
 ...
 <div class="row">
   <div class="col-12">
   <nav class="navbar "> <b><font class="text-primary" style="font-size:34px">Shop<font class="text-danger">kart</font></font></b> </nav>
  </div>
  <div class="col-12 col-sm-12" align="center">
   <nav class="container bg-success"><br><br><font color="#FFF" size="+6">Order Confirmed</font><br><br><br></nav>
  </div>
  </div>
