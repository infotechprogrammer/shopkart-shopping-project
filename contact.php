...
?>      
  ...
  <div class="row">
  <div class="col-12">
   <nav class="navbar navbar-dark  bg-warning"><font style="color:#FFF; font-size:35px">Contact Us</font></nav>
  </div>
   <div class="col-12">
   <nav class="navbar "><marquee> <b><font class="text-primary" style="font-size:34px">Shop<font class="text-danger">kart</font> <font class="text-success">Location</font></font></b></marquee> </nav>
  </div>
  </div>
       ...
       <div class="col-md-12">
         <div class="aa-contact-area">
           <div class="aa-contact-top">
             ...
             <p>CT Group of Institutions (Shahpur Campus),Lambri,Punjab,near Nakodar Road </p>
           </div>
           <!-- contact map -->
